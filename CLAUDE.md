...
**Cards vs full-prompt agents**: most agents are cards (compact `.md` with Overview / When to use / Approach / Output format). Five flagship agents (code-quality-reviewer, crypto-security-reviewer, investigator, atomic-engineer, infrastructure-auditor) contain the full system prompt inline.
